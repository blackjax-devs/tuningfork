...
"""Tests for the laplace_hmc base method registry entry.
...
from tuningfork.base_method.laplace_hmc import ENTRY
...
class TestLaplaceHMCEntryFields:
    """ENTRY field validation for laplace_hmc."""

    def test_name(self) -> None:
        assert ENTRY.name == "laplace_hmc"
...
class TestLaplaceHMCFactorySmoke:
