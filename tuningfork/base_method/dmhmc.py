...
"""Dynamic Multinomial HMC (dmhmc) algorithm entry for the tuningfork algorithm
registry.
...
sets internally — they are not directly recipe-resolved. The only declared scalar
