...
def _runner(
    ...
    **kwargs
    ...
    # Pin is_mass_matrix_diagonal=False for dense adaptation
...
ENTRY = Warmup(
    ...
    notes=(
        ...
        "Compatible with hmc, nuts, barker, mala (all kernels that accept "
        "inverse_mass_matrix).  Verified by tripwire tests.  Use when posterior "
