...
from tuningfork.warmup.low_rank_window_adaptation import (
    ENTRY as _low_rank_window_adaptation,
)
...
WARMUPS: dict[str, Warmup] = {
    ...
    _low_rank_window_adaptation.name: _low_rank_window_adaptation,
