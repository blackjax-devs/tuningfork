...
No detailed investigations recorded yet. If sampling pathologies emerge during Recipe Phase 1+, case studies will be logged to `worklog/lessons/case-studies/logistic_synthetic/`.
