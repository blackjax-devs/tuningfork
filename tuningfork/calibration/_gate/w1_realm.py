...
def _ess_gen_per_dim(gen_arr: np.ndarray) -> np.ndarray:
    ...
    split-chain; Vehtari et al. 2021) and ``blackjax.diagnostics.ess_tail``
    for tail ESS (canonical 5th/95th-percentile pair, Vehtari 2021, matching
    ``az.ess(method="tail")``).
    ...
    # Tail ESS: canonical 5th/95th-percentile pair (Vehtari 2021).
