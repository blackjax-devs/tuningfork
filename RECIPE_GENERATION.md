...
> This matrix prioritizes recipe cells. The
> [codegen-first recipe lifecycle](docs/design/codegen-first-recipes.md)
> governs how experiments run and how evidence is retained. If this historical
> planning document conflicts with that architecture, the design document wins.
